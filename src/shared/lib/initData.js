...
const products = [
  {
    ...
    name: "Смартфон X",
    description:
      "Современный смартфон с отличной камерой, 6.5-дюймовый дисплей, 128 ГБ памяти, 8 ГБ ОЗУ, батарея 5000 мАч. Поддерживает быструю зарядку и беспроводную зарядку.",
    price: 29990,
    discount: 10,
  ...
  },
  {
    ...
    description:
      "Удобные джинсы из качественного денима. Классический крой, подходят под любую обувь. Состав: 98% хлопок, 2% эластан.",
    price: 3490,
    discount: 0,
    category: "Одежда",
    images: [
  ...
  },
  {
    ...
    description:
      "Полное руководство по React. Изучите хуки, контекст, роутинг, управление состоянием и многое другое. Автор: Алекс Бэнкс.",
    price: 1200,
    discount: 5,
    category: "Книги",
    images: [
